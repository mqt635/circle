# 让网页赏心悦目、让阅读回归初心 - Circle 提供舒适的阅读体验

Circle 是网页阅读助手，可以把网页中的内容提取出来，重新整理渲染成更方便阅读的排版界面。目前已经上架 Chrome、Firfox、Microsoft Edge 和 360 扩展市场。[马上安装](https://ranhe.xyz/circle-install/)
...
![Circle 舒适美观的界面](https://ranhe.xyz/post-images/1625039765100.jpg)
...
![Circle 跟随系统](https://ranhe.xyz/post-images/1625045908039.jpg)
...
但是算法无法做到 100% 完美效果，为此对于无法识别的正文，你可以使用聚焦模式，直接选取正文，噪音信息就可以消失
...
![Circle 大纲展示](https://ranhe.xyz/post-images/1625042857502.jpg)
...
如果觉得 Circle 还不错，欢迎升级为高级帐户支持 Circle 更好的发展
